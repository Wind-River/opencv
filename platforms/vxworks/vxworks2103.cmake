...
include($ENV{WIND_SDK_HOME}/vxsdk/sysroot/mk/rtp.toolchain.cmake)
...
set(CMAKE_FIND_ROOT_PATH $ENV{WIND_SDK_HOME})
...
set(CMAKE_CXX_FLAGS           "-I${CMAKE_BINARY_DIR} -I${CMAKE_SOURCE_DIR}/3rdparty/protobuf/src -DGOOGLE_PROTOBUF_HAS_CXX11_HASH  -D_XOPEN_SOURCE  ${CMAKE_CXX_FLAGS}"  CACHE INTERNAL "" FORCE)
set(CMAKE_C_FLAGS             "-I${CMAKE_BINARY_DIR} -I${CMAKE_SOURCE_DIR}/3rdparty/protobuf/src -DGOOGLE_PROTOBUF_HAS_CXX11_HASH  -D_XOPEN_SOURCE  ${CMAKE_C_FLAGS}"  CACHE INTERNAL "" FORCE )

#Forcing options that are irrelevant for vxWorks OFF
set(WITH_IPP OFF  CACHE INTERNAL "" FORCE)
set(WITH_OPENJPEG ON CACHE INTERNAL "" FORCE)
set(BUILD_OPENJPEG ON CACHE INTERNAL "" FORCE)
...
set(HAVE_WORDS_BIGENDIAN OFF CACHE INTERNAL "" FORCE)
...
set(PYTHON3_INCLUDE_PATH $ENV{WIND_SDK_HOME}/vxsdk/sysroot/usr/3pp/deploy/usr/include/python3.8)
set(PYTHON3_LIBRARIES  $ENV{WIND_SDK_HOME}/vxsdk/sysroot/usr/3pp/deploy/usr/lib/libpython3.8.so)
set(PYTHON3_NUMPY_INCLUDE_DIRS  $ENV{WIND_SDK_HOME}/vxsdk/sysroot/usr/3pp/deploy/usr/lib/python3.8/site-packages/numpy-1.18.1-py3.8-linux-x86_64.egg/numpy/core/include/)
